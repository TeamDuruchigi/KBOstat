...
function player_select_each(num){
    ...
    var material_team_each = new THREE.MeshBasicMaterial({ color: team_bg_color_primary, opacity:0.5,
        transparent: true,});
    ...
    if(player_data[selected_player[0]][5] == "타자")
    {
        ...
        if(player_data[selected_player[0]][7] < 0.5)
        {
            ...
            if(player_data[selected_player[0]][8] < 3)
                shape_first.lineTo(x - sin72 * y_length * player_data[selected_player[0]][8] / 3, y + cos72 * y_length * player_data[selected_player[0]][8] / 3);
            else
                shape_first.lineTo(x - sin72 * y_length, y + cos72 * y_length);
            if ( player_data[selected_player[0]][9] < 18.5)
                shape_first.lineTo(x - cos54 * y_length * player_data[selected_player[0]][9] / 18.5, y - sin54 * y_length * player_data[selected_player[0]][9] / 18.5);
            else
                shape_first.lineTo(x - cos54 * y_length, y - sin54 * y_length);
            if( player_data[selected_player[0]][10] < 3)
                shape_first.lineTo(x + cos54 * y_length * player_data[selected_player[0]][10] / 3, y - sin54 * y_length * player_data[selected_player[0]][10] / 3);
            else
                shape_first.lineTo(x + cos54 * y_length, y - sin54 * y_length);
            if( player_data[selected_player[0]][11] < 40)
                shape_first.lineTo(x + sin72 * y_length * player_data[selected_player[0]][11] / 40, y + cos72 * y_length * player_data[selected_player[0]][11] / 40);
            else
                shape_first.lineTo(x + sin72 * y_length, y + cos72 * y_length);
            shape_first.moveTo(x, y + y_length * player_data[selected_player[0]][7] * 2 );
        }
        ...
        radar_first = new THREE.Mesh(geometry_first, material_team_each);
    ...
    else// 투수일 경우
    {
        ...
        {
            shape_first.moveTo(x, y + y_length * player_data[selected_player[0]][7] / 9);
            if(player_data[selected_player[0]][8] < 35)
                shape_first.lineTo(x - sin72 * y_length * player_data[selected_player[0]][8] / 35, y + cos72 * y_length * player_data[selected_player[0]][8] / 35);
            else
                shape_first.lineTo(x - sin72 * y_length, y + cos72 * y_length);
            if ( player_data[selected_player[0]][9] < 2.5)
                shape_first.lineTo(x - cos54 * y_length * player_data[selected_player[0]][9] / 2.5, y - sin54 * y_length * player_data[selected_player[0]][9] / 2.5);
            else
                shape_first.lineTo(x - cos54 * y_length, y - sin54 * y_length);
            if( player_data[selected_player[0]][10] < 2.5)
                shape_first.lineTo(x + cos54 * y_length * player_data[selected_player[0]][10] / 2.5, y - sin54 * y_length * player_data[selected_player[0]][10] / 2.5);
            else
                shape_first.lineTo(x + cos54 * y_length, y - sin54 * y_length);
            if( player_data[selected_player[0]][11] < 1.5)
                shape_first.lineTo(x + sin72 * y_length * player_data[selected_player[0]][11] / 1.5, y + cos72 * y_length * player_data[selected_player[0]][11] / 1.5);
            else
                shape_first.lineTo(x + sin72 * y_length, y + cos72 * y_length);
            shape_first.moveTo(x, y + y_length * player_data[selected_player[0]][7] / 9 );
        }
